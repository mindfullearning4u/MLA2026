# MCR Unit 4 Lessons 5-6 Build Audit Report

## Executive Summary

Math for College Readiness Unit 4 Lessons 5 and 6 were built and audited using the MLA Audit Reporting Format and the approved MCR gold-standard lesson model.

Unit Focus: Financial Literacy and Personal Finance

Final Recommendation: PASS

## Strengths

- Lesson 5 follows the approved Math for College Readiness mapping: Insurance and Risk.
- Lesson 6 follows the approved Math for College Readiness mapping: Retirement, Savings, and Long-Term Planning.
...
|---|---|
| MLA.MCR.FL.11 | L05 GP, L05 Quiz |
| MLA.MCR.FL.12 | L06 GP, L06 Quiz |

## Assessment Coverage Summary

| File | Count | Status |
|---|---:|---|
| MCR_U04_L05_GuidedPractice.gift | 5 | PASS |
| MCR_U04_L05_Quiz.gift | 25 | PASS |
| MCR_U04_L06_GuidedPractice.gift | 5 | PASS |
| MCR_U04_L06_Quiz.gift | 25 | PASS |
