...
| Source Type | Required Source | Environmental Science Use |
|---|---|---|
| Florida course source | CPALMS Environmental Science course record, course number `2001340`, course record `23803`, current version `2024 - And Beyond (current)` | Primary source for Environmental Science course identity, benchmark list, course notes, laboratory expectation, and embedded support standards. |
| Florida science benchmarks | CPALMS / Florida NGSSS science benchmark records for `SC.912.*` standards | Primary content standards for Environmental Science. |
...
| Florida MTR expectations | CPALMS embedded MTR expectations | Used only for graphs, maps, data displays, measurement, models, monitoring parameters, and quantitative reasoning support. |
| Health support standards | CPALMS embedded health standards when referenced | Used only where the Environmental Science course requires environmental health, public health, or risk-context support. |
| Common Core Literacy in Science and Technical Subjects | Common Core literacy support references when needed for science reading/writing alignment | Support only; not a replacement for Florida Environmental Science benchmarks. |
...
- `ENV_LAB_AND_VIRTUAL_LAB_MATRIX.md`
- `ENV_TEXT_AND_DATA_SOURCE_MATRIX.md`
- `.codex/standards/16-science-lab-and-virtual-lab-standard.md`

If a lesson below identifies a required visual, map, graph, data table, food web, climate data set, population model, land-use map, pollution data set, case source, investigation, or simulation review, the lesson developer and assessment developer must treat it as required unless the main agent documents a standards-based reason for excluding it.
...
|---|---|---|---|---|---|
| Unit 1 | Inquiry, lab safety, environmental monitoring, data quality, source reliability, models, maps, and decisions | Safety scenarios, environmental monitoring tables, data graphs, map/model examples, claim-evidence-reasoning organizers | Required for monitoring design, source reliability, environmental data displays, and model interpretation | Fieldwork must be observation-only unless TOR-approved; use data/model tasks by default | Include claim/source excerpts, monitoring data tables, graphs, models, maps, and investigation scenarios |
| Unit 2 | Ecosystem change, biotic/abiotic systems, species relationships, food webs, energy flow, biodiversity, invasive species | Food webs, energy pyramids, ecosystem diagrams, species interaction tables, biodiversity graphs, invasive spread maps | Required for ecosystem succession, food webs, energy transfer, biodiversity, and invasive species models | No live specimen handling required unless TOR-approved; use images, models, simulations, and public data | Include ecosystem diagrams, food webs, interaction tables, biodiversity data, and invasive species case stimuli |
| Unit 3 | Population structure, population change, carrying capacity, human impact, environmental health, public health, resource-use cases | Population pyramids, density/distribution maps, carrying-capacity graphs, resource-use tables, environmental health data displays | Required for population dynamics, carrying capacity, human impact, and health/environment case models | No personal health data collection; use public or fictionalized data and privacy-safe case information | Include population graphs, carrying-capacity models, human-impact data, and environmental health case stimuli |
| Unit 4 | Renewable/nonrenewable resources, resource availability, energy technologies, land use, forests, wildlife, water, fossil fuels, management decisions | Resource comparison tables, renewal-rate graphs, energy technology diagrams, land-use maps, water/wildlife/forest data | Required for resource availability, energy consequences, land-use planning, and management tradeoff models | No field collection, machinery, fuel handling, or physical resource testing unless TOR-approved | Include resource data, land-use maps, energy/resource comparison tables, and management decision matrices |
| Unit 5 | Climate conditions, ocean/atmosphere/hydrology influences, pollution, waste, technology, biotechnology, Florida impacts | Climate graphs, Florida maps, ocean/atmosphere diagrams, pollution data tables, waste-flow diagrams, technology impact charts | Required for climate data, pollution models, waste-management decisions, and technology/biotechnology impact analysis | No pollutant handling, waste sorting, water testing, or biotechnology activity unless TOR-approved | Include climate graphs, pollution data, Florida environmental case maps, waste scenarios, and technology impact stimuli |
| Unit 6 | Monitoring parameters, policy decisions, lifestyle impacts, sustainability, conservation, stewardship, environmental justice, future systems | Monitoring reports, policy tradeoff matrices, sustainability footprint models, conservation maps, future-scenario graphs | Required for policy simulation, sustainability models, conservation planning, and future environmental systems | No personal lifestyle data disclosure required; use anonymized, fictionalized, or public data | Include monitoring reports, policy scenarios, sustainability data, conservation case stimuli, and decision matrices |
...
| 1 | 03 | Environmental Data, Maps, and Models | Data display and model interpretation investigation | Data table; graph; map; model/legend/key examples | EPA data tools; NOAA; USGS; NASA Earthdata | Data table, graph, map, or model stimulus |
| 1 | 04 | Trends, Uncertainty, and Monitoring Parameters | Monitoring parameter and uncertainty analysis | Trend graph; uncertainty table; monitoring parameter chart | EPA; NOAA climate/weather data; USGS water data | Monitoring data table/graph |
...
| 2 | 04 | Food Webs and Trophic Levels | Food web and trophic-level model investigation | Food web; trophic pyramid; producer/consumer/decomposer chart | PhET where applicable; CK-12; HHMI; CPALMS | Food web/trophic model |
...
| 3 | 04 | Human Population and Resource Use | Human impact and resource-use case analysis | Resource-use chart; human impact map; trend graph | EPA; Our World in Data if approved; NOAA; CPALMS | Human impact/resource data stimulus |
...
| 4 | 04 | Water, Wildlife, Forests, and Fossil Fuels | Resource system evidence analysis | Water/wildlife/forest/fossil fuel data table; resource map | USGS Water Science School; FWC; USFS; EIA | Resource system map/data |
...
| 5 | 04 | Waste Management Strategies | Waste-management strategy case analysis | Waste stream diagram; management comparison table | EPA; local/state waste agencies; CPALMS | Waste scenario/comparison table |
...
| 6 | 04 | Conservation and Stewardship | Conservation solution case analysis | Conservation map; stewardship solution table | FWC; USFWS; National Park Service; CPALMS | Conservation case/map |
...
Environmental Science lab planning must default to safe virtual labs, simulations, public data sets, teacher-provided data, maps, images, videos, models, or paper/data investigations unless a physical activity is explicitly approved.

Do not require students to handle pollutants, collect unknown water/soil/biological samples, sort waste, perform outdoor fieldwork, share personal health/lifestyle data, travel to field sites, observe hazardous events, or conduct household experiments without TOR/school-approved safety controls.

## Architecture Validation

| Requirement | Status |
|---|---|
| Official CPALMS Environmental Science source identified | PASS |
