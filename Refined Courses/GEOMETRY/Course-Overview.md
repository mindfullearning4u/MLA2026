...
Geometry is a mastery-based course that develops students' understanding of geometric relationships, reasoning, proof, congruence, similarity, transformations, circles, coordinate geometry, measurement, and mathematical modeling.

Students explore geometry through visual reasoning, logical argumentation, mathematical communication, and real-world problem solving. The course emphasizes conceptual understanding, precision, justification, and the application of geometric principles to authentic situations.
...
- Use geometric vocabulary, notation, tools, and diagrams with precision  
- Construct and evaluate logical arguments and geometric proofs  
- Analyze triangle congruence, quadrilateral relationships, and geometric properties  
- Apply transformations to reason about congruence and similarity  
- Use similarity, right-triangle relationships, and trigonometric ratios to solve problems  
- Analyze circle relationships, constructions, arc length, and sector area  
- Use coordinate geometry to classify figures, write circle equations, and solve problems  
- Apply area, surface area, volume, scale, and modeling concepts to real-world situations  

---

## Prerequisite Knowledge / Skills

Students entering Geometry should have prior experience with the following concepts. Foundational skills are reviewed, reinforced, and extended throughout the course as needed.

- Basic geometric vocabulary and recognition of common figures  
- Coordinate plane concepts, ordered pairs, and graphing  
- Operations with integers, fractions, decimals, and square roots  
- Ratios, proportions, and percent relationships  
- Basic expressions, equations, and formula substitution  
- Measurement units, perimeter, area, and angle measurement  
- Interpretation of diagrams, tables, and real-world problem situations  
...
The course is organized into six units, each designed to build progressively on geometric concepts and standards mastery.
...
Geometry integrates foundational skills essential for college readiness and future academic success. Students develop:

- Visual reasoning and spatial analysis  
- Logical reasoning, proof, and mathematical justification  
- Interpretation of geometric diagrams, measurements, and models  
- Application of geometric relationships to real-world situations  
