# Unit 3 Production Status

## Approved scope

- Eight lesson crosswalks preserved in `Crosswalk/`
- Lessons 1–8 use the seven-page sequence P01–P07
- Lessons 1–7 include 25-question quiz-bank XML packages
- Lesson 8 includes a separate Historian's Notebook submission and Mastery Checkpoint; no regular lesson quiz
- Unit 3 Pretest contains 10 questions and remains diagnostic/zero weight
- Unit 3 Assessment pool contains 40 questions for a 10-question stratified delivery

## Local validation completed

- 56 HTML lesson pages present
- TOR support present on all 56 pages
- Vocabulary foundation and checkpoint checklist present in every lesson
- No obsolete SS.912 standards in the rebuilt Unit 3 pages or assessment XML
- No Guided Practice assessment XML remains
- XML parses successfully
- Question counts: 25 per Lesson 1–7 bank, 10 Pretest, 40 Unit Assessment
- Lesson 8 does not have a lesson-quiz XML
