# PFLE - Personal Financial Literacy and Economics
**Credit:** 1.0 High School Social Studies and Financial Literacy Credit  
**Course Type:** Mastery-Based High School Personal Financial Literacy and Economics Course  

---

## Course Description

Personal Financial Literacy and Economics teaches students to use economics and personal finance evidence to make responsible decisions about income, budgeting, banking, credit, investing, insurance, consumer protection, markets, and major life choices.
...
- Florida personal financial literacy and economics expectations; CPALMS social studies and financial literacy support; Florida B.E.S.T. literacy support; Common Core literacy support; SAT evidence/data expectations; ACT reading/research expectations
...
- Apply economic decision-making, incentives, opportunity cost, markets, and tradeoffs to financial choices.
- Analyze earning income, careers, taxes, benefits, and financial stability.
- Create and evaluate budgets, banking decisions, saving plans, and consumer choices.
- Explain creditworthiness, borrowing costs, debt risk, consumer protection, and credit decisions.
- Analyze investing, retirement, insurance, risk, return, and long-term planning.
- Integrate economics and personal finance into realistic life decisions and capstone planning.
- Use charts, tables, decision matrices, data displays, and financial scenarios to support choices.
- Demonstrate mastery through standards-aligned checkpoints, quizzes, XML assessments, and unit tasks.
...
- Basic arithmetic, percent reasoning, reading charts and tables, interpreting scenarios, and explaining decisions with evidence.
...
- Unit 1: Economic Decision-Making and Market Thinking
- Unit 2: Earning Income, Careers, Taxes, and Benefits
- Unit 3: Budgeting, Banking, Saving, and Consumer Decisions
- Unit 4: Credit, Borrowing, Debt, and Consumer Protection
- Unit 5: Investing, Retirement, Insurance, and Risk Management
- Unit 6: Life Decisions, Financial Systems, and Capstone Planning
...
This course builds skills essential for financial independence, economic reasoning, consumer decision-making, career planning, and adult life readiness. Students develop:
