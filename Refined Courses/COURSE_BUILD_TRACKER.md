...
| Status | Meaning |
|---|---|
| Complete | Course work exists in the repo and has been built through that stage. |
| Moodle transfer ready | Course has completed production, lessons, assessments, and final audit requirements and is ready to transfer. |
| In Moodle transfer | Transfer work has started or is actively being completed. |
...
| English III | English / Language Arts | 1.0 | Complete | Complete | Moodle transfer ready | In Moodle transfer - final audit pending |
...
These courses have active course folders and have been treated as course-build complete in the current workspace.
...
| English / Language Arts | English III | `ENGLISH III` | Complete | Complete | Complete | Moodle transfer ready | In Moodle transfer - final audit pending | Assessment question banks and activities transferred; previous block corrected for `U4 L3 Guided Practice` and `U6 Final Assessment`. Final enrollment-readiness audit still required. See `ENGLISH III\Course Audit\ENGLISH_III_MOODLE_ASSESSMENT_ACTIVITY_PLACEMENT_LOG_2026-07-11.md`. |
...
The following should be updated only after a transfer agent or Moodle verification confirms completion.
