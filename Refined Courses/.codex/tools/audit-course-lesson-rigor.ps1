...
if ([string]::IsNullOrWhiteSpace($CourseCode)) {
  $CourseCode = Split-Path -Leaf $resolvedRoot
}
...
$lines.Add("# $CourseCode Lesson Rigor Depth Audit")
$lines.Add("")
