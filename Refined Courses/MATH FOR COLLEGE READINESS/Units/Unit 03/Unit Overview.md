# MATH FOR COLLEGE READINESS - Unit 03 Overview: Data Literacy and Interpretation
...
- using technology or spreadsheets when appropriate.

These concepts support data interpretation, comparison, and evaluation of statistical claims in this unit.
...
|--------|--------------|---------------------|------------|
| Lesson 1 | Selecting and Interpreting Data Displays | MA.912.DP.1.1, MA.912.DP.1.2 | Quiz |
