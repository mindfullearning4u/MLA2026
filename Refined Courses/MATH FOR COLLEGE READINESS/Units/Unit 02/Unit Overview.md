# MATH FOR COLLEGE READINESS - Unit 02 Overview: Algebra in Real-World Contexts
...
| MA.912.AR.2.2 | Write a linear two-variable equation to represent the relationship between two quantities from a graph, a written description or a table of values within a mathematical or real-world context. |
...
|--------|--------------|---------------------|------------|
| Lesson 1 | Writing and Solving Linear Equations in Context | MA.912.AR.2.1 | Quiz |
| Lesson 2 | Linear Relationships from Graphs, Tables, and Descriptions | MA.912.AR.2.2 | Quiz |
