# MATH FOR COLLEGE READINESS - Unit 06 Overview: Measurement, Modeling, and Applied Geometry
...
These concepts support applied measurement, spatial reasoning, and geometric modeling in this unit.
...
|--------|--------------|---------------------|------------|
| Lesson 1 | Similarity, Scale, and Proportional Measurement | MA.912.GR.1.6 | Quiz |
| Lesson 2 | Coordinate Geometry for Perimeter and Area | MA.912.GR.3.4 | Quiz |
