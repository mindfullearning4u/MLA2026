# ENGLISH III - Unit 01 Overview: Advanced Analysis of Text and Meaning
...
These concepts support advanced text analysis, evidence-based response, and academic communication in this unit.
...
|--------|--------------|---------------------|------------|
| Lesson 1 | Close Reading and Annotation of Complex Texts | ELA.11.R.1.1 | Quiz |
| Lesson 2 | Key Elements and Layers of Meaning | ELA.11.R.1.1 | Quiz |
...
- evaluation of key elements and functional significance;
- paraphrasing and comprehension;
- academic vocabulary use;
- standard English conventions;
- evidence-based analytical response.

Assessment items require students to evaluate how key elements contribute to meaning and style, explain their functional significance in interpretation, paraphrase grade-level texts accurately, integrate academic vocabulary, apply conventions, and write structured analytical responses supported by textual evidence.
...
This unit builds the analytical reading and writing habits used throughout English III. Students learn to evaluate how meaning is constructed, restate ideas accurately, use academic language precisely, apply conventions, and support analysis with evidence.
