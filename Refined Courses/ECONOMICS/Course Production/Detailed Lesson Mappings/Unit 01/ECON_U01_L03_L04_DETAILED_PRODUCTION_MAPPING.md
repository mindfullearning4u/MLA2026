...
Codex must create an exact key from the final fictional Checkpoint scenario.

Specify:

- the incentive and whether it increases a perceived benefit or cost;
- the supported predicted behavioral response;
- the intended consequence;
- at least one scenario-supported unintended consequence;
- marginal benefit and marginal cost for each required decision point;
- the supported stopping decision and its economic justification;
- the next-best alternative forgone as the opportunity cost;
- the best-supported alternative under the stated criteria;
- the evidence required in the student's justification;
- acceptable alternative conclusions when different stated preferences or constraints support them;
- unacceptable reasoning, including treating positive/negative incentives as moral labels, confusing marginal with total values, or omitting the next-best alternative; and
- misconception-based automatic revision triggers.

Do not award full mastery for a recommendation that lacks marginal reasoning, opportunity cost, or scenario evidence.
