# STATISTICS - Unit 02 Overview: Measures of Center, Variability, and Distributions
...
| MA.912.DP.2.2 | Use the mean and standard deviation of a data set to fit it to a normal distribution and to estimate population percentages. Recognize that there are data sets for which such a procedure is not appropriate. |
| MA.912.DP.2.3 | Estimate population percentages from data that has been fit to the normal distribution. |
...
|--------|--------------|---------------------|------------|
| Lesson 1 | Measures of Center for Numerical Data | MA.912.DP.2.1 | Quiz |
| Lesson 2 | Measures of Variability for Numerical Data | MA.912.DP.2.1 | Quiz |
| Lesson 3 | Comparing Data Sets and Accounting for Outliers | MA.912.DP.2.1 | Quiz |
