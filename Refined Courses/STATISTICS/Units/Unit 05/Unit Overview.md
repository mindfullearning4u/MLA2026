# STATISTICS - Unit 05 Overview: Sampling, Bias, and Statistical Inference
...
| MA.912.DP.5.9 | Compare two treatments using data from an experiment in which the treatments are assigned randomly. |
...
|--------|--------------|---------------------|------------|
| Lesson 1 | Population Parameters, Sample Statistics, and Random Sampling | MA.912.DP.5.1, MA.912.DP.5.2 | Quiz |
| Lesson 2 | Sampling Methods and Bias | MA.912.DP.5.3 | Quiz |
| Lesson 3 | Sample Surveys, Margin of Error, and Confidence Level | MA.912.DP.1.4, MA.912.DP.1.5 | Quiz |
