# Statistics Unit 1 Lesson 5 Audit

## Executive Summary
Statistics Unit 1 Lesson 5 was built and audited using the MLA Audit Reporting Format.

Final Recommendation: PASS

## Strengths
- Lesson 5 follows the approved Statistics mapping: Interpreting Components and Quantities in Data Displays.
...
- Feedback supports interpretation of titles, labels, scales, frequencies, relative frequencies, and supported conclusions.
...
|---|---|
| MLA.STAT.STQ.2 | L05 Guided Practice, L05 Quiz |

## Assessment Coverage Summary
| File | Count | Status |
|---|---:|---|
| STAT_U01_L05_GuidedPractice.gift | 5 | PASS |
| STAT_U01_L05_Quiz.gift | 25 | PASS |
