Executive Summary
Precalculus Unit 6 Lesson 1, Arithmetic Sequences, was built and audited using the MLA Audit Reporting Format.
...
MLA.PC.SEQ.1	Guided Practice, Lesson Quiz
