# ENGLISH I - Unit 03 Overview: Informational Text and Argument
...
|--------|--------------|---------------------|------------|
| Lesson 1 | Text Structures and Text Features | ELA.9.R.2.1 | Quiz |
| Lesson 2 | Central Ideas and Supporting Evidence | ELA.9.R.2.2 | Quiz |
...
- conceptual understanding;
- informational text structure and features;
