# Chemistry Phase 3A-B-3: Lab, Visual, Simulation, and Resource Mapping
...
| Source Type | Required Source | Chemistry Use |
|---|---|---|
| Florida course source | CPALMS Chemistry 1 course record, course number `2003340`, course record `23853`, current version `2024 - And Beyond (current)` | Primary source for Chemistry 1 course identity, benchmark list, course notes, laboratory expectation, and embedded support standards. |
| Florida science benchmarks | CPALMS / Florida NGSSS science benchmark records for `SC.912.*` standards | Primary content standards for Chemistry. |
...
| Florida MTR expectations | CPALMS embedded MTR expectations | Used only for measurement, significant figures, scientific notation, graphing, stoichiometry, gas data, pH, rate data, and quantitative reasoning support. |
| Common Core Literacy in Science and Technical Subjects | Common Core literacy support references when needed for science reading/writing alignment | Support only; not a replacement for Florida Chemistry benchmarks. |
...
|---|---|---|---|---|---|
| Unit 1 | Scientific inquiry, lab safety, measurement, significant figures, scientific notation, matter classification, properties, data analysis | Safety charts, apparatus diagrams, measurement tools, data tables, line graphs, particle models, matter classification charts, physical/chemical change evidence | Required for safety/procedure practice, measurement/data analysis, and particle models | No unsupervised chemical handling; use virtual labs/data unless TOR-approved | Include procedure scenarios, apparatus/safety visuals, measurement tables, graphs, particle diagrams, and matter classification evidence |
| Unit 2 | Atomic theory evidence, atomic particles, isotopes, periodic table organization, trends, quantized energy, electromagnetic spectrum | Atomic model timeline, nuclear/atomic diagrams, isotope tables, periodic table excerpts, trend graphs, energy level diagrams, EM spectrum diagrams | Required for atomic models, periodic trends, energy levels, and spectra | Use virtual spectra and models; no flame tests or radiation-related activities without TOR-approved controls | Include atomic models, isotope data, periodic table sections, trend data, spectrum diagrams, and energy level models |
| Unit 3 | Bonding, ionic/covalent/metallic models, formulas, compound composition, nomenclature, intermolecular forces | Lewis/electron diagrams, ionic lattice models, molecular structure diagrams, formula charts, naming tables, intermolecular force models, structure-property tables | Required for bonding models, molecular geometry, ionic/covalent comparisons, and intermolecular forces | Use models/simulations; no student chemical synthesis without TOR-approved safety controls | Include bonding diagrams, formulas, molecular/ionic models, nomenclature tables, and property evidence |
| Unit 4 | Reaction evidence, reaction classification, conservation of mass, chemical equations, mole concept, stoichiometry, nuclear vs chemical reactions, reaction data | Reaction evidence tables, balanced equation models, mole road maps, stoichiometry tables, mass conservation diagrams, nuclear vs chemical comparison charts, data/calculation tables | Required for balancing equations, conservation, mole/stoichiometry, and reaction classification | Avoid unsupervised reactions; use video/data/simulation evidence unless TOR-approved | Include reaction evidence, equations, mole/stoichiometry data, conservation models, and nuclear/chemical comparison stimuli |
| Unit 5 | Energy transformations, molecular kinetic energy, potential energy diagrams, endothermic/exothermic processes, gases, phase changes, solutions, concentration | Energy flow diagrams, potential energy graphs, particle motion models, gas law graphs/tables, phase change diagrams, heating/cooling curves, solution diagrams, concentration tables | Required for thermochemistry, gas behavior, phase changes, and solutions | No heat/flame/pressure experiments without TOR-approved controls; virtual/data preferred | Include energy diagrams, particle/gas models, gas data graphs, phase diagrams, solution/concentration tables |
| Unit 6 | Acids/bases, pH, reaction rates, concentration effects, temperature/catalyst effects, equilibrium, chemistry in society, claims evaluation | pH scale, hydronium/hydroxide models, pH data tables, rate graphs, catalyst energy diagrams, equilibrium models, claims/source evaluation tables | Required for pH, rate factors, catalysts, equilibrium, and real-world claims | No household acid/base mixing or chemical testing without TOR-approved controls; use virtual/data/case studies | Include pH data, rate graphs, catalyst/equilibrium models, and real-world chemistry evidence/source stimuli |
...
| 1 | 03 | Measurement, Units, and Significant Figures | Measurement precision and unit conversion data practice | Measuring tool images/diagrams; significant-figure table; unit conversion flow | OpenStax Chemistry 2e; CK-12 measurement resources | Measurement table/tool diagram |
| 1 | 04 | Data Tables, Graphs, Precision, and Uncertainty | Data table/graph construction and uncertainty analysis | Data table; graph; precision vs accuracy model; error/outlier example | Concord Consortium data resources; OpenStax Chemistry 2e | Data table and graph |
...
| 2 | 04 | Electron Arrangement and Periodic Position | Electron arrangement and periodic location model | Periodic table section; energy level/electron diagram | PhET Build an Atom; OpenStax Chemistry 2e; CK-12 | Periodic table/electron model |
...
| 3 | 04 | Metallic Bonding and Material Properties | Structure-property evidence analysis | Metallic bonding model; property evidence table | OpenStax Chemistry 2e; CK-12 | Metallic bonding model/property table |
...
| 4 | 04 | The Mole Concept | Mole-particle-mass conversion model | Mole road map; conversion table; particle/mass model | OpenStax Chemistry 2e; CK-12 | Mole conversion table |
...
| 5 | 04 | Endothermic and Exothermic Processes | Heat flow/process classification | Endothermic/exothermic energy diagrams; temperature change data table | OpenStax Chemistry 2e; CK-12 | Heat flow diagram/data |
...
| 6 | 04 | Temperature, Catalysts, and Reaction Rates | Temperature/catalyst rate data and model analysis | Catalyst energy diagram; rate data table; collision model | PhET Reactions and Rates; OpenStax Chemistry 2e | Catalyst/rate graph or diagram |
...
Chemistry lab planning must default to safe virtual labs, simulations, public data sets, teacher-provided data, videos, models, or paper/data investigations unless a physical activity is explicitly approved.

Do not require students to use acids, bases, household chemicals, flames, hot plates, glassware, pressure containers, gases, unknown substances, or reaction mixtures without TOR/school-approved safety controls.

## Architecture Validation

| Requirement | Status |
|---|---|
| Official CPALMS Chemistry 1 source identified | PASS |
